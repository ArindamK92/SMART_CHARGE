...
if __name__ == "__main__":
    ...
    for n_ev in range(n_ev_min, n_ev_max +1, 5):
        for itr in range(max_itr):
            ...
            matched_s, matched_c = match(ev_list, cp_list, Pref, PCG)
            end_time = time.time()
            elapsed_time_SMEVCA_PCG = (end_time - start_time) * 1000
            results_SMEVCA_PCG = charging_analysis(cp_list, ev_list, matched_c)
            unmatched_SMEVCA_PCG = find_unmatched(matched_s)
            ...
            matched_s, matched_c = match(ev_list, cp_list, Pref, PCD)
            end_time = time.time()
            elapsed_time_SMEVCA_PCD = (end_time - start_time) * 1000
            results_SMEVCA_PCD = charging_analysis(cp_list, ev_list, matched_c)
            unmatched_SMEVCA_PCD = find_unmatched(matched_s)
            ...
            with open(csv_file, mode='a', newline='') as file:
                ...
                writer.writerow([itr, 'PCG', n_ev, q, results_PCG[0], results_PCG[1], results_PCG[2], results_PCG[3], results_PCG[4], results_PCG[5], results_PCG[6], unmatched_PCG, elapsed_time_PCG, results_PCG[7], results_PCG[8], results_PCG[9], results_PCG[10]]) 
                ...
                writer.writerow([itr, 'PCD', n_ev, q, results_PCD[0], results_PCD[1], results_PCD[2], results_PCD[3], results_PCD[4], results_PCD[5], results_PCD[6], unmatched_PCD, elapsed_time_PCD, results_PCD[7], results_PCD[8], results_PCD[9], results_PCD[10]]) 
                ...
                writer.writerow([itr, 'PCL', n_ev, q, results_PCL[0], results_PCL[1], results_PCL[2], results_PCL[3], results_PCL[4], results_PCL[5], results_PCL[6], unmatched_PCL, elapsed_time_PCL, results_PCL[7], results_PCL[8], results_PCL[9], results_PCL[10]]) 

                writer.writerow([itr, 'SMEVCA-D', n_ev, q, results_SMEVCA_PCD[0], results_SMEVCA_PCD[1], results_SMEVCA_PCD[2], results_SMEVCA_PCD[3], results_SMEVCA_PCD[4], results_SMEVCA_PCD[5], results_SMEVCA_PCD[6], unmatched_SMEVCA_PCD, elapsed_time_SMEVCA_PCD, results_SMEVCA_PCD[7], results_SMEVCA_PCD[8], results_SMEVCA_PCD[9], results_SMEVCA_PCD[10]]) 
                
                writer.writerow([itr, 'SMEVCA-G', n_ev, q, results_SMEVCA_PCG[0], results_SMEVCA_PCG[1], results_SMEVCA_PCG[2], results_SMEVCA_PCG[3], results_SMEVCA_PCG[4], results_SMEVCA_PCG[5], results_SMEVCA_PCG[6], unmatched_SMEVCA_PCG, elapsed_time_SMEVCA_PCG, results_SMEVCA_PCG[7], results_SMEVCA_PCG[8], results_SMEVCA_PCG[9], results_SMEVCA_PCG[10]])  


    
    
    
    plot_varyingEV(csv_file, q)
