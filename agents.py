# -*- coding: utf-8 -*-
"""
Created on Tue Jul 23 14:53:05 2024
...
class EV:
    ...
    def compute_preference_new(self, cp_list, beta1=1, beta2=1):
...
class CP:
    ...
    """
    def __init__(self, ID, x_loc, y_loc, theta, eta, ucost, q=2, r_j=1, t_free_j=0):
        self.ID = ID
        self.x_loc = x_loc
        self.y_loc = y_loc
        self.r_j = r_j
